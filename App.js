...
import LogoImage from './assets/images/delivery-logo.jpg'; // Importing the logo image

const Header = () => (
    <div className='header'>
        <div className='logo-container'>
            {console.log('Rendering Header Component', LogoImage)}
            <img className='logo'
                // src={LogoImage}
    ...
    <div className='body'>
        ...
        <div className='res-container'>
            { resList.map((restaurant) => (
                console.log(restaurant.data.id,restaurant),
